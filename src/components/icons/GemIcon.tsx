...
/**
 * Figma pill leading-icon for Gems — gem outline, 13.17×12 leaf in the 14×14 slot.
 */
export function GemIcon({ className }: IconProps) {
  return (
    <PillGlyph className={className} width={13.1667} height={12.0001}>
      <path
