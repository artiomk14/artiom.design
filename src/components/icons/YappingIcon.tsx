...
/**
 * Yapping — the sent vertical pencil (tip, ferrule, three-column body).
 * Same 14×14 slot and stroke-draw as Gems / Heavy Ones.
 */
export function YappingIcon({ className }: IconProps) {
  return (
    <PillGlyph className={className} viewBox="0 0 24 24" strokeWidth={2.5}>
      ...
      <path d="M10 5h4" strokeLinecap="round" strokeLinejoin="round" />
    </PillGlyph>
  );
}
