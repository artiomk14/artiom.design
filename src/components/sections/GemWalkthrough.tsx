...
import { Beam, Button, SmoothSurface } from '@/components/ui';
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          <SmoothSurface
            radius="3xl"
            shadow={[...shadow.elevationXlLayers]}
            innerBorder={{
              width: 1,
              color: colors.border.secondary,
              opacity: 1,
            }}
            className="t-resize flex w-full flex-col overflow-hidden bg-background p-2"
          >
            <div
              className={cn('t-gem-media', complete && 'is-collapsed')}
              aria-hidden={complete}
            >
              <div className="t-gem-media-inner">
                <SmoothSurface
                  radius="2xl"
            ...
            {complete ? (
              <div className="flex w-full flex-col items-center justify-center gap-7 overflow-hidden px-5 py-11">
                ...
                <div className="flex w-full items-center justify-between">
                  ...
                  <div className="flex shrink-0 items-center justify-end gap-4">
                    <Button
                      ...
                      aria-hidden={isFirst}
                      className={
                        isFirst ? 'pointer-events-none opacity-0' : undefined
                      }
                      onClick={goPrevious}
                    />
                    <span
                    ...
                    <Button
                      ...
                      aria-label={isLast ? 'Complete walkthrough' : 'Next step'}
                      onClick={goNext}
                    />
                  </div>
                </div>
