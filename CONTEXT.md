...
*Figma `content-item` (124:655) holds each gem (20px sides, 128px top, 144px bottom; height follows the gem’s max). Gems stay at the designed size (no hover scale). First gem is the WC26 walkthrough: complete step, then Reset (`class=neutral`) in the gray holder. Gems (and later tab panels) use `OverflowFade` — a background-tinted fold fade that hints there is more to scroll. Remaining slots stay empty. Next: more Gems.*
...
| Gems stay at designed size | Walkthrough (and later gems) keep the Figma 420px size in the holder. No hover/focus scale. | 2026-08-26 |
...
*Last updated: 2026-08-26 (Gems stay at designed size; sliding pill fill; overflow fade at the fold)*
