...
*Figma `hero-section` (110:563) + `content_container` (124:583) on Home. Iterating pill icons one-by-one (Gems + Heavy Ones + Yapping pencil). No PR until owner is happy.*
